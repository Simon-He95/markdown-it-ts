...
For the Markstream consumer pipeline, see the [streaming and history restore audit](./docs/perf-markstream-consumer.md), including all 59 workloads, CPU samples, and rejected experiments.
